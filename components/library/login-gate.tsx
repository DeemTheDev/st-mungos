// The same no-JS cookie gate as /session, /notes and /flashcards
// (lib/admin-auth.ts), shared by /library and /review so the copy lives in one
// place. Server component — plain HTML form POST to /api/admin/login with a
// same-site `next` so it bounces straight back to the page she wanted.
...
export function LibraryLoginGate({
  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center bg-neutral-950 px-4 text-neutral-200">
